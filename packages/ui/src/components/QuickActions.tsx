...
const QuickActions: React.FC<QuickActionsProps> = ({ 
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-slate-900/95 backdrop-blur-xl border-r border-slate-700/80 z-10 overflow-y-auto hidden lg:block">
      <div className="p-6">
        {/* App Branding */}
          ...
          {actions.map((action, index) => (
            action.isButton ? (
              <button
                ...
                className="w-full p-3 bg-slate-700/50 rounded-lg hover:bg-slate-700/70 transition-colors text-left"
              >
