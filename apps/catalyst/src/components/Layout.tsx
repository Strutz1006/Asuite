...
import { Target, BarChart3, TrendingUp, Menu, X, Grid3X3, Zap, Activity, Eye, Workflow, CheckSquare, Users, Route } from 'lucide-react'
...
const suiteApps = [
  ...
  { name: 'Catalyst', href: '/', icon: Zap, active: true },
              ...
              <div className="flex items-center h-16 flex-shrink-0 px-4 border-b border-slate-700/80">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-xl font-bold text-slate-100">
                    Aesyros <span className="text-violet-400">Catalyst</span>
                  </span>
                </div>
              </div>
