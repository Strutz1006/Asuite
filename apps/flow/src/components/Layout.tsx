...
import { Target, BarChart3, TrendingUp, Menu, X, Grid3X3, Zap, Activity, Eye, Workflow, CheckSquare, FileText, Shield } from 'lucide-react'
...
const suiteApps = [
  ...
  { name: 'Flow', href: '/', icon: Workflow, active: true },
              ...
              <div className="flex items-center h-16 flex-shrink-0 px-4 border-b border-slate-700/80">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-xl font-bold text-slate-100">
                    Aesyros <span className="text-green-400">Flow</span>
                  </span>
                </div>
              </div>
